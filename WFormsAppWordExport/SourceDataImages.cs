...
if (( DateTime.Today-date.date).TotalDays > 5600) return true;
...
return false;",new int []{ }),new  ESSENSES_IMEG(16,"Сведения о школе", 2,null,new int []{ }),new  ESSENSES_IMEG(17,"Сведения о прибытии на место ДТП", 1,null,new int []{ })};
        ...
        { allChooceAnswer.Add(80,new Choose_Answer(80,"3.1",0,getImageFromFile("803.1.bmp"),-1));
 ...
 allChooceAnswer.Add(67,new Choose_Answer(67,"2.1",0,getImageFromFile("672.1.bmp"),-1));
 ...
 allChooceAnswer.Add(464,new Choose_Answer(464,"r1.1",0,getImageFromFile("464r1.1.bmp"),-1));
 ...
 allChooceAnswer.Add(460,new Choose_Answer(460,"Сухое",0,null,-1));
 allChooceAnswer.Add(500,new Choose_Answer(500,"1-А",0,null,-1));
 allChooceAnswer.Add(421,new Choose_Answer(421,"Разовый",0,null,-1));
 allChooceAnswer.Add(506,new Choose_Answer(506,"муниципальная",0,null,-1));
 allChooceAnswer.Add(509,new Choose_Answer(509,"искусственное, включено, исправно",0,null,-1));
 allChooceAnswer.Add(518,new Choose_Answer(518,"левое",0,null,-1));
 allChooceAnswer.Add(525,new Choose_Answer(525,"спереди справа",0,null,-1));
 allChooceAnswer.Add(538,new Choose_Answer(538,"не было",0,null,-1));
 allChooceAnswer.Add(544,new Choose_Answer(544,"Сведения о школе",0,null,16));
 allChooceAnswer.Add(545,new Choose_Answer(545,"отказался от госпитализации",0,null,-1));
 allChooceAnswer.Add(522,new Choose_Answer(522,"Юр. лицо",0,null,-1));
 allChooceAnswer.Add(523,new Choose_Answer(523,"индивидуальный предприниматель",1,null,-1));
 allChooceAnswer.Add(546,new Choose_Answer(546,"доставлен",1,null,-1));
 allChooceAnswer.Add(539,new Choose_Answer(539,"родители",1,null,-1));
 allChooceAnswer.Add(526,new Choose_Answer(526,"спереди слева",1,null,-1));
 allChooceAnswer.Add(519,new Choose_Answer(519,"правое",1,null,-1));
 allChooceAnswer.Add(510,new Choose_Answer(510,"искусственное, отсутствует",1,null,-1));
 allChooceAnswer.Add(507,new Choose_Answer(507,"частная",1,null,-1));
 allChooceAnswer.Add(422,new Choose_Answer(422,"постоянный",1,null,-1));
 allChooceAnswer.Add(501,new Choose_Answer(501,"1-Б",1,null,-1));
 allChooceAnswer.Add(461,new Choose_Answer(461,"Мокрое",1,null,-1));
 ...
 allChooceAnswer.Add(465,new Choose_Answer(465,"r1.2.2",1,getImageFromFile("465r1.2.2.bmp"),-1));
 ...
 allChooceAnswer.Add(68,new Choose_Answer(68,"2.2",1,getImageFromFile("682.2.bmp"),-1));
 ...
 allChooceAnswer.Add(81,new Choose_Answer(81,"3.2",1,getImageFromFile("813.2.bmp"),-1));
 allChooceAnswer.Add(82,new Choose_Answer(82,"3.3",2,getImageFromFile("823.3.bmp"),-1));
 ...
 allChooceAnswer.Add(69,new Choose_Answer(69,"2.3.1",2,getImageFromFile("692.3.1.bmp"),-1));
 ...
 allChooceAnswer.Add(466,new Choose_Answer(466,"r1.3",2,getImageFromFile("466r1.3.bmp"),-1));
 ...
 allChooceAnswer.Add(462,new Choose_Answer(462,"заснежанное",2,null,-1));
 allChooceAnswer.Add(502,new Choose_Answer(502,"2",2,null,-1));
 allChooceAnswer.Add(423,new Choose_Answer(423,"школа-дом-школа",2,null,-1));
 allChooceAnswer.Add(508,new Choose_Answer(508,"федеральная",2,null,-1));
 allChooceAnswer.Add(511,new Choose_Answer(511,"искусственное, выключено, исправно ",2,null,-1));
 allChooceAnswer.Add(520,new Choose_Answer(520,"дублирующие учебные педали",2,null,-1));
 allChooceAnswer.Add(527,new Choose_Answer(527,"сзади слева",2,null,-1));
 allChooceAnswer.Add(540,new Choose_Answer(540,"родственники",2,null,-1));
 allChooceAnswer.Add(547,new Choose_Answer(547,"скончался во время госпитализации",2,null,-1));
 allChooceAnswer.Add(524,new Choose_Answer(524,"физ. лицо",2,null,-1));
 allChooceAnswer.Add(548,new Choose_Answer(548,"сбежал",3,null,-1));
 allChooceAnswer.Add(541,new Choose_Answer(541,"знакомые ",3,null,-1));
 allChooceAnswer.Add(528,new Choose_Answer(528,"сзади справа",3,null,-1));
 allChooceAnswer.Add(521,new Choose_Answer(521,"дублирующие управление инвалида",3,null,-1));
 allChooceAnswer.Add(512,new Choose_Answer(512,"искусственное, включено, неисправно",3,null,-1));
 allChooceAnswer.Add(503,new Choose_Answer(503,"3",3,null,-1));
 allChooceAnswer.Add(463,new Choose_Answer(463,"гололед",3,null,-1));
 allChooceAnswer.Add(447,new Choose_Answer(447,"тротуар",3,null,-1));
 allChooceAnswer.Add(443,new Choose_Answer(443,"D",3,null,-1));
 allChooceAnswer.Add(467,new Choose_Answer(467,"r1.4",3,getImageFromFile("467r1.4.bmp"),-1));
 ...
 allChooceAnswer.Add(70,new Choose_Answer(70,"2.3.2",3,getImageFromFile("702.3.2.bmp"),-1));
 ...
 allChooceAnswer.Add(83,new Choose_Answer(83,"3.4",3,getImageFromFile("833.4.bmp"),-1));
 allChooceAnswer.Add(84,new Choose_Answer(84,"3.5",4,getImageFromFile("843.5.bmp"),-1));
 ...
 allChooceAnswer.Add(71,new Choose_Answer(71,"2.3.3",4,getImageFromFile("712.3.3.bmp"),-1));
 ...
 allChooceAnswer.Add(468,new Choose_Answer(468,"r1.5",4,getImageFromFile("468r1.5.bmp"),-1));
 allChooceAnswer.Add(448,new Choose_Answer(448,"пешеходная дорожка",4,null,-1));
 allChooceAnswer.Add(504,new Choose_Answer(504,"4",4,null,-1));
 allChooceAnswer.Add(513,new Choose_Answer(513,"естественное",4,null,-1));
 allChooceAnswer.Add(529,new Choose_Answer(529,"сзади посередине",4,null,-1));
 allChooceAnswer.Add(542,new Choose_Answer(542,"педагоги",4,null,-1));
 allChooceAnswer.Add(543,new Choose_Answer(543,"друзья",5,null,-1));
 allChooceAnswer.Add(505,new Choose_Answer(505,"5",5,null,-1));
 allChooceAnswer.Add(469,new Choose_Answer(469,"r1.6",5,getImageFromFile("469r1.6.bmp"),-1));
 ...
 allChooceAnswer.Add(72,new Choose_Answer(72,"2.3.4",5,getImageFromFile("722.3.4.bmp"),-1));
 ...
 allChooceAnswer.Add(85,new Choose_Answer(85,"3.6",5,getImageFromFile("853.6.bmp"),-1));
 allChooceAnswer.Add(86,new Choose_Answer(86,"3.7",6,getImageFromFile("863.7.bmp"),-1));
 ...
 allChooceAnswer.Add(73,new Choose_Answer(73,"2.3.5",6,getImageFromFile("732.3.5.bmp"),-1));
 ...
 allChooceAnswer.Add(470,new Choose_Answer(470,"r1.7",6,getImageFromFile("470r1.7.bmp"),-1));
 allChooceAnswer.Add(471,new Choose_Answer(471,"r1.8",7,getImageFromFile("471r1.8.bmp"),-1));
 ...
 allChooceAnswer.Add(74,new Choose_Answer(74,"2.3.6",7,getImageFromFile("742.3.6.bmp"),-1));
 ...
 allChooceAnswer.Add(87,new Choose_Answer(87,"3.8",7,getImageFromFile("873.8.bmp"),-1));
 allChooceAnswer.Add(88,new Choose_Answer(88,"3.9",8,getImageFromFile("883.9.bmp"),-1));
 ...
 allChooceAnswer.Add(75,new Choose_Answer(75,"2.3.7",8,getImageFromFile("752.3.7.bmp"),-1));
 ...
 allChooceAnswer.Add(472,new Choose_Answer(472,"r1.9",8,getImageFromFile("472r1.9.bmp"),-1));
 allChooceAnswer.Add(473,new Choose_Answer(473,"r1.10",9,getImageFromFile("473r1.10.bmp"),-1));
 allChooceAnswer.Add(315,new Choose_Answer(315,"10",9,null,-1));
 allChooceAnswer.Add(279,new Choose_Answer(279,"10",9,null,-1));
 allChooceAnswer.Add(76,new Choose_Answer(76,"2.4",9,getImageFromFile("762.4.bmp"),-1));
 allChooceAnswer.Add(32,new Choose_Answer(32,"подземный пешеходный переход",9,null,-1));
 allChooceAnswer.Add(89,new Choose_Answer(89,"3.10",9,getImageFromFile("893.10.bmp"),-1));
 allChooceAnswer.Add(90,new Choose_Answer(90,"3.11",10,getImageFromFile("903.11.bmp"),-1));
 allChooceAnswer.Add(77,new Choose_Answer(77,"2.5",10,getImageFromFile("772.5.bmp"),-1));
 allChooceAnswer.Add(280,new Choose_Answer(280,"11",10,null,-1));
 allChooceAnswer.Add(316,new Choose_Answer(316,"11",10,null,-1));
 allChooceAnswer.Add(474,new Choose_Answer(474,"r1.11",10,getImageFromFile("474r1.11.bmp"),-1));
 allChooceAnswer.Add(475,new Choose_Answer(475,"r1.12",11,getImageFromFile("475r1.12.bmp"),-1));
 allChooceAnswer.Add(317,new Choose_Answer(317,"12",11,null,-1));
 allChooceAnswer.Add(281,new Choose_Answer(281,"12",11,null,-1));
 allChooceAnswer.Add(78,new Choose_Answer(78,"2.6",11,getImageFromFile("782.6.bmp"),-1));
 allChooceAnswer.Add(91,new Choose_Answer(91,"3.12",11,getImageFromFile("913.12.bmp"),-1));
 allChooceAnswer.Add(92,new Choose_Answer(92,"3.13",12,getImageFromFile("923.13.bmp"),-1));
 allChooceAnswer.Add(79,new Choose_Answer(79,"2.7",12,getImageFromFile("792.7.bmp"),-1));
 allChooceAnswer.Add(476,new Choose_Answer(476,"r1.13",12,getImageFromFile("476r1.13.bmp"),-1));
 allChooceAnswer.Add(477,new Choose_Answer(477,"r1.14.1",13,getImageFromFile("477r1.14.1.bmp"),-1));
 allChooceAnswer.Add(93,new Choose_Answer(93,"3.14",13,getImageFromFile("933.14.bmp"),-1));
 allChooceAnswer.Add(94,new Choose_Answer(94,"3.15",14,getImageFromFile("943.15.bmp"),-1));
 allChooceAnswer.Add(478,new Choose_Answer(478,"r1.14.2",14,getImageFromFile("478r1.14.2.bmp"),-1));
 allChooceAnswer.Add(479,new Choose_Answer(479,"r1.15",15,getImageFromFile("479r1.15.bmp"),-1));
 allChooceAnswer.Add(95,new Choose_Answer(95,"3.16",15,getImageFromFile("953.16.bmp"),-1));
 allChooceAnswer.Add(96,new Choose_Answer(96,"3.17.1",16,getImageFromFile("963.17.1.bmp"),-1));
 allChooceAnswer.Add(480,new Choose_Answer(480,"r1.16.2",16,getImageFromFile("480r1.16.2.bmp"),-1));
 allChooceAnswer.Add(481,new Choose_Answer(481,"r1.17",17,getImageFromFile("481r1.17.bmp"),-1));
 allChooceAnswer.Add(97,new Choose_Answer(97,"3.17.2",17,getImageFromFile("973.17.2.bmp"),-1));
 allChooceAnswer.Add(98,new Choose_Answer(98,"3.17.3",18,getImageFromFile("983.17.3.bmp"),-1));
 allChooceAnswer.Add(482,new Choose_Answer(482,"r1.18",18,getImageFromFile("482r1.18.bmp"),-1));
 allChooceAnswer.Add(483,new Choose_Answer(483,"r1.19",19,getImageFromFile("483r1.19.bmp"),-1));
 allChooceAnswer.Add(99,new Choose_Answer(99,"3.18.1",19,getImageFromFile("993.18.1.bmp"),-1));
 allChooceAnswer.Add(100,new Choose_Answer(100,"3.18.2",20,getImageFromFile("1003.18.2.bmp"),-1));
 allChooceAnswer.Add(484,new Choose_Answer(484,"r1.20",20,getImageFromFile("484r1.20.bmp"),-1));
 allChooceAnswer.Add(485,new Choose_Answer(485,"r1.21",21,getImageFromFile("485r1.21.bmp"),-1));
 allChooceAnswer.Add(101,new Choose_Answer(101,"3.19",21,getImageFromFile("1013.19.bmp"),-1));
 allChooceAnswer.Add(102,new Choose_Answer(102,"3.20",22,getImageFromFile("1023.20.bmp"),-1));
 allChooceAnswer.Add(486,new Choose_Answer(486,"r1.22",22,getImageFromFile("486r1.22.bmp"),-1));
 allChooceAnswer.Add(487,new Choose_Answer(487,"r1.23",23,getImageFromFile("487r1.23.bmp"),-1));
 allChooceAnswer.Add(103,new Choose_Answer(103,"3.21",23,getImageFromFile("1033.21.bmp"),-1));
 allChooceAnswer.Add(104,new Choose_Answer(104,"3.22",24,getImageFromFile("1043.22.bmp"),-1));
 allChooceAnswer.Add(488,new Choose_Answer(488,"r1.24.1",24,getImageFromFile("488r1.24.1.bmp"),-1));
 allChooceAnswer.Add(489,new Choose_Answer(489,"r1.24.2",25,getImageFromFile("489r1.24.2.bmp"),-1));
 allChooceAnswer.Add(105,new Choose_Answer(105,"3.23",25,getImageFromFile("1053.23.bmp"),-1));
 allChooceAnswer.Add(106,new Choose_Answer(106,"3.24",26,getImageFromFile("1063.24.bmp"),-1));
 allChooceAnswer.Add(490,new Choose_Answer(490,"r1.24.3",26,getImageFromFile("490r1.24.3.bmp"),-1));
 allChooceAnswer.Add(491,new Choose_Answer(491,"r1.25",27,getImageFromFile("491r1.25.bmp"),-1));
 allChooceAnswer.Add(107,new Choose_Answer(107,"3.25",27,getImageFromFile("1073.25.bmp"),-1));
 allChooceAnswer.Add(108,new Choose_Answer(108,"3.26",28,getImageFromFile("1083.26.bmp"),-1));
 allChooceAnswer.Add(492,new Choose_Answer(492,"r2.1.3",28,getImageFromFile("492r2.1.3.bmp"),-1));
 allChooceAnswer.Add(493,new Choose_Answer(493,"r2.2",29,getImageFromFile("493r2.2.bmp"),-1));
 allChooceAnswer.Add(109,new Choose_Answer(109,"3.27",29,getImageFromFile("1093.27.bmp"),-1));
 allChooceAnswer.Add(110,new Choose_Answer(110,"3.28",30,getImageFromFile("1103.28.bmp"),-1));
 allChooceAnswer.Add(494,new Choose_Answer(494,"r2.3",30,getImageFromFile("494r2.3.bmp"),-1));
 allChooceAnswer.Add(495,new Choose_Answer(495,"r2.4",31,getImageFromFile("495r2.4.bmp"),-1));
 allChooceAnswer.Add(111,new Choose_Answer(111,"3.29",31,getImageFromFile("1113.29.bmp"),-1));
 allChooceAnswer.Add(112,new Choose_Answer(112,"3.30",32,getImageFromFile("1123.30.bmp"),-1));
 allChooceAnswer.Add(496,new Choose_Answer(496,"r2.5",32,getImageFromFile("496r2.5.bmp"),-1));
 allChooceAnswer.Add(497,new Choose_Answer(497,"r2.6",33,getImageFromFile("497r2.6.bmp"),-1));
 allChooceAnswer.Add(113,new Choose_Answer(113,"3.31",33,getImageFromFile("1133.31.bmp"),-1));
 allChooceAnswer.Add(114,new Choose_Answer(114,"2.7",34,getImageFromFile("1142.7.bmp"),-1));
 allChooceAnswer.Add(498,new Choose_Answer(498,"r2.7",34,getImageFromFile("498r2.7.bmp"),-1));
 allChooceAnswer.Add(499,new Choose_Answer(499,"r1.1",35,getImageFromFile("499r1.1.bmp"),-1));
 allChooceAnswer.Add(115,new Choose_Answer(115,"2.1",35,getImageFromFile("1152.1.bmp"),-1));
 allChooceAnswer.Add(116,new Choose_Answer(116,"2.2",36,getImageFromFile("1162.2.bmp"),-1));
 allChooceAnswer.Add(117,new Choose_Answer(117,"2.3.1",37,getImageFromFile("1172.3.1.bmp"),-1));
 allChooceAnswer.Add(118,new Choose_Answer(118,"2.3.2",38,getImageFromFile("1182.3.2.bmp"),-1));
 allChooceAnswer.Add(119,new Choose_Answer(119,"2.3.3",39,getImageFromFile("1192.3.3.bmp"),-1));
 allChooceAnswer.Add(120,new Choose_Answer(120,"2.3.4",40,getImageFromFile("1202.3.4.bmp"),-1));
 allChooceAnswer.Add(121,new Choose_Answer(121,"2.3.5",41,getImageFromFile("1212.3.5.bmp"),-1));
 allChooceAnswer.Add(122,new Choose_Answer(122,"2.3.6",42,getImageFromFile("1222.3.6.bmp"),-1));
 allChooceAnswer.Add(123,new Choose_Answer(123,"2.3.7",43,getImageFromFile("1232.3.7.bmp"),-1));
 allChooceAnswer.Add(124,new Choose_Answer(124,"2.4",44,getImageFromFile("1242.4.bmp"),-1));
 allChooceAnswer.Add(125,new Choose_Answer(125,"2.5",45,getImageFromFile("1252.5.bmp"),-1));
 allChooceAnswer.Add(126,new Choose_Answer(126,"2.6",46,getImageFromFile("1262.6.bmp"),-1));
 allChooceAnswer.Add(127,new Choose_Answer(127,"4.8.2",47,getImageFromFile("1274.8.2.bmp"),-1));
 allChooceAnswer.Add(128,new Choose_Answer(128,"4.1.1",48,getImageFromFile("1284.1.1.bmp"),-1));
 allChooceAnswer.Add(129,new Choose_Answer(129,"4.1.2",49,getImageFromFile("1294.1.2.bmp"),-1));
 allChooceAnswer.Add(130,new Choose_Answer(130,"4.1.3",50,getImageFromFile("1304.1.3.bmp"),-1));
 allChooceAnswer.Add(131,new Choose_Answer(131,"4.1.4",51,getImageFromFile("1314.1.4.bmp"),-1));
 allChooceAnswer.Add(132,new Choose_Answer(132,"4.1.5",52,getImageFromFile("1324.1.5.bmp"),-1));
 allChooceAnswer.Add(133,new Choose_Answer(133,"4.1.6",53,getImageFromFile("1334.1.6.bmp"),-1));
 allChooceAnswer.Add(134,new Choose_Answer(134,"4.2.1",54,getImageFromFile("1344.2.1.bmp"),-1));
 allChooceAnswer.Add(135,new Choose_Answer(135,"4.2.2",55,getImageFromFile("1354.2.2.bmp"),-1));
 allChooceAnswer.Add(136,new Choose_Answer(136,"4.2.3",56,getImageFromFile("1364.2.3.bmp"),-1));
 allChooceAnswer.Add(137,new Choose_Answer(137,"4.3",57,getImageFromFile("1374.3.bmp"),-1));
 allChooceAnswer.Add(138,new Choose_Answer(138,"4.4",58,getImageFromFile("1384.4.bmp"),-1));
 allChooceAnswer.Add(139,new Choose_Answer(139,"4.5",59,getImageFromFile("1394.5.bmp"),-1));
 allChooceAnswer.Add(140,new Choose_Answer(140,"4.6",60,getImageFromFile("1404.6.bmp"),-1));
 allChooceAnswer.Add(141,new Choose_Answer(141,"4.7",61,getImageFromFile("1414.7.bmp"),-1));
 allChooceAnswer.Add(142,new Choose_Answer(142,"4.8.1",62,getImageFromFile("1424.8.1.bmp"),-1));
 allChooceAnswer.Add(143,new Choose_Answer(143,"1.34.3",63,getImageFromFile("1431.34.3.bmp"),-1));
 allChooceAnswer.Add(144,new Choose_Answer(144,"1.1",64,getImageFromFile("1441.1.bmp"),-1));
 allChooceAnswer.Add(145,new Choose_Answer(145,"1.2",65,getImageFromFile("1451.2.bmp"),-1));
 allChooceAnswer.Add(146,new Choose_Answer(146,"1.3.1",66,getImageFromFile("1461.3.1.bmp"),-1));
 allChooceAnswer.Add(147,new Choose_Answer(147,"1.3.2",67,getImageFromFile("1471.3.2.bmp"),-1));
 allChooceAnswer.Add(148,new Choose_Answer(148,"1.4.1",68,getImageFromFile("1481.4.1.bmp"),-1));
 allChooceAnswer.Add(149,new Choose_Answer(149,"1.4.2",69,getImageFromFile("1491.4.2.bmp"),-1));
 allChooceAnswer.Add(150,new Choose_Answer(150,"1.4.3",70,getImageFromFile("1501.4.3.bmp"),-1));
 allChooceAnswer.Add(151,new Choose_Answer(151,"1.5",71,getImageFromFile("1511.5.bmp"),-1));
 allChooceAnswer.Add(152,new Choose_Answer(152,"1.6",72,getImageFromFile("1521.6.bmp"),-1));
 allChooceAnswer.Add(153,new Choose_Answer(153,"1.7",73,getImageFromFile("1531.7.bmp"),-1));
 allChooceAnswer.Add(154,new Choose_Answer(154,"1.8",74,getImageFromFile("1541.8.bmp"),-1));
 allChooceAnswer.Add(155,new Choose_Answer(155,"1.9",75,getImageFromFile("1551.9.bmp"),-1));
 allChooceAnswer.Add(156,new Choose_Answer(156,"1.10",76,getImageFromFile("1561.10.bmp"),-1));
 allChooceAnswer.Add(157,new Choose_Answer(157,"1.11.1",77,getImageFromFile("1571.11.1.bmp"),-1));
 allChooceAnswer.Add(158,new Choose_Answer(158,"1.11.2",78,getImageFromFile("1581.11.2.bmp"),-1));
 allChooceAnswer.Add(159,new Choose_Answer(159,"1.12.1",79,getImageFromFile("1591.12.1.bmp"),-1));
 allChooceAnswer.Add(160,new Choose_Answer(160,"1.12.2",80,getImageFromFile("1601.12.2.bmp"),-1));
 allChooceAnswer.Add(161,new Choose_Answer(161,"1.13",81,getImageFromFile("1611.13.bmp"),-1));
 allChooceAnswer.Add(162,new Choose_Answer(162,"1.14",82,getImageFromFile("1621.14.bmp"),-1));
 allChooceAnswer.Add(163,new Choose_Answer(163,"1.15",83,getImageFromFile("1631.15.bmp"),-1));
 allChooceAnswer.Add(164,new Choose_Answer(164,"1.16",84,getImageFromFile("1641.16.bmp"),-1));
 allChooceAnswer.Add(165,new Choose_Answer(165,"1.17",85,getImageFromFile("1651.17.bmp"),-1));
 allChooceAnswer.Add(166,new Choose_Answer(166,"1.18",86,getImageFromFile("1661.18.bmp"),-1));
 allChooceAnswer.Add(167,new Choose_Answer(167,"1.19",87,getImageFromFile("1671.19.bmp"),-1));
 allChooceAnswer.Add(168,new Choose_Answer(168,"1.20.1",88,getImageFromFile("1681.20.1.bmp"),-1));
 allChooceAnswer.Add(169,new Choose_Answer(169,"1.20.2",89,getImageFromFile("1691.20.2.bmp"),-1));
 allChooceAnswer.Add(170,new Choose_Answer(170,"1.20.3",90,getImageFromFile("1701.20.3.bmp"),-1));
 allChooceAnswer.Add(171,new Choose_Answer(171,"1.21",91,getImageFromFile("1711.21.bmp"),-1));
 allChooceAnswer.Add(172,new Choose_Answer(172,"1.22",92,getImageFromFile("1721.22.bmp"),-1));
 allChooceAnswer.Add(173,new Choose_Answer(173,"1.23",93,getImageFromFile("1731.23.bmp"),-1));
 allChooceAnswer.Add(174,new Choose_Answer(174,"1.24",94,getImageFromFile("1741.24.bmp"),-1));
 allChooceAnswer.Add(175,new Choose_Answer(175,"1.25",95,getImageFromFile("1751.25.bmp"),-1));
 allChooceAnswer.Add(176,new Choose_Answer(176,"1.26",96,getImageFromFile("1761.26.bmp"),-1));
 allChooceAnswer.Add(177,new Choose_Answer(177,"1.27",97,getImageFromFile("1771.27.bmp"),-1));
 allChooceAnswer.Add(178,new Choose_Answer(178,"1.28",98,getImageFromFile("1781.28.bmp"),-1));
 allChooceAnswer.Add(179,new Choose_Answer(179,"1.29",99,getImageFromFile("1791.29.bmp"),-1));
 allChooceAnswer.Add(180,new Choose_Answer(180,"1.30",100,getImageFromFile("1801.30.bmp"),-1));
 allChooceAnswer.Add(181,new Choose_Answer(181,"1.31",101,getImageFromFile("1811.31.bmp"),-1));
 allChooceAnswer.Add(182,new Choose_Answer(182,"1.32",102,getImageFromFile("1821.32.bmp"),-1));
 allChooceAnswer.Add(183,new Choose_Answer(183,"1.33",103,getImageFromFile("1831.33.bmp"),-1));
 allChooceAnswer.Add(184,new Choose_Answer(184,"1.34.1",104,getImageFromFile("1841.34.1.bmp"),-1));
 allChooceAnswer.Add(185,new Choose_Answer(185,"1.34.2",105,getImageFromFile("1851.34.2.bmp"),-1));
allFeatureImages.Add(146,new  FEATURE_IMAGE(146,"год", 7,new int[]{},null,null) );
allFeatureImages.Add(147,new  FEATURE_IMAGE(147,"год.мес", 8,new int[]{},null,null) );
allFeatureImages.Add(148,new  FEATURE_IMAGE(148,"год мес день", 9,new int[]{},null,null) );
allFeatureImages.Add(149,new  FEATURE_IMAGE(149,"год мес день время", 10,new int[]{},null,null) );
allFeatureImages.Add(150,new  FEATURE_IMAGE(150,"мес день время", 11,new int[]{},null,null) );
allFeatureImages.Add(151,new  FEATURE_IMAGE(151,"время", 12,new int[]{},null,null) );
...
allFeatureImages.Add(128,new  FEATURE_IMAGE(128,"Дата выдачи водительских прав", 9,new int[]{}, @"return currEssence.getFeatureByImage(127)[0].answer !=null;",null) );
...
allFeatureImages.Add(132,new  FEATURE_IMAGE(132,"Дата последнего медицинского освидетельсвоания ", 9,new int[]{},null,null) );
...
allFeatureImages.Add(124,new  FEATURE_IMAGE(124,"Место в машине", 0,new int[]{525,526,527,528,529},null,null) );
...
allFeatureImages.Add(101,new  FEATURE_IMAGE(101,"Сведения о госпитализации", 0,new int[]{545,546,547,548},null,null) );
allFeatureImages.Add(145,new  FEATURE_IMAGE(145,"Учится?", 3,new int[]{},null,null) );
allFeatureImages.Add(97,new  FEATURE_IMAGE(97,"Посещаемая образовательная организация", 6,new int[]{544}, @" if ( currEssence.getFeatureByImage(145)[0].answer== null || currEssence.getFeatureByImage(145)[0].answer.intAnswer == 0 ) return false; 

 if ( currEssence.getFeatureByImage(93)[0].answer== null ) return false;
DateSaver date =currEssence.getFeatureByImage(93)[0].answer.dateAnswer;

if (( DateTime.Today-date.date).TotalDays <= 1500) return false;
return true;",null) );
allFeatureImages.Add(98,new  FEATURE_IMAGE(98,"Класс", 0,new int[]{}, @" if ( currEssence.getFeatureByImage(145)[0].answer== null || currEssence.getFeatureByImage(145)[0].answer.intAnswer == 0 ) return false; 
...
return currEssence.getFeatureByImage(97)[0].answer !=null;",null) );
allFeatureImages.Add(110,new  FEATURE_IMAGE(110,"Сопровождающие на момент ДТП", 0,new int[]{538,539,540,541,542,543},null,null) );
...
allFeatureImages.Add(93,new  FEATURE_IMAGE(93,"Дата Рождения", 9,new int[]{},null,null) );
...
allFeatureImages.Add(73,new  FEATURE_IMAGE(73,"Марка/Модель", 0,new int[]{},null,null) );
allFeatureImages.Add(144,new  FEATURE_IMAGE(144,"Тип рулевого управления", 2,new int[]{518,519,520,521},null,null) );
allFeatureImages.Add(75,new  FEATURE_IMAGE(75,"Государственный регистрационный знак", 0,new int[]{},null, @" if ( currFeature.answer!=null )
     currEssence.sName= currFeature.answer.sAnswer;
") );
allFeatureImages.Add(70,new  FEATURE_IMAGE(70,"Владелец ТС", 2,new int[]{522,523,524},null,null) );
...
allFeatureImages.Add(79,new  FEATURE_IMAGE(79,"Год выпуска", 7,new int[]{},null,null) );
allFeatureImages.Add(80,new  FEATURE_IMAGE(80,"Общий пробег", 0,new int[]{},null,null) );
allFeatureImages.Add(81,new  FEATURE_IMAGE(81,"Дата проведения тех. обслуживания", 8,new int[]{},null,null) );
allFeatureImages.Add(82,new  FEATURE_IMAGE(82,"Пробег после тех. обслуживания", 0,new int[]{},null, @"if ( currEssence.getFeatureByImage(80)[0].answer!=null && currFeature.answer!=null
 && currEssence.getFeatureByImage(80)[0].answer.intAnswer >  currFeature.answer.intAnswer ){
    currFeature.answer.intAnswer =currEssence.getFeatureByImage(80)[0].answer.intAnswer ;

}") );
allFeatureImages.Add(83,new  FEATURE_IMAGE(83,"Цвет", 0,new int[]{},null,null) );
allFeatureImages.Add(143,new  FEATURE_IMAGE(143,"Тонировка задней полусферы", 0,new int[]{},null,null) );
...
allFeatureImages.Add(64,new  FEATURE_IMAGE(64,"Где был наряд во время ДТП", 0,new int[]{},null,null) );
allFeatureImages.Add(63,new  FEATURE_IMAGE(63,"Время прибытия наряда ДПС на место ДТП", 12,new int[]{},null,null) );
...
allFeatureImages.Add(56,new  FEATURE_IMAGE(56,"Дата", 10,new int[]{},null,null) );
...
allFeatureImages.Add(10,new  FEATURE_IMAGE(10,"Состояние проезжей части", 0,new int[]{460,461,462,463},null,null) );
...
allFeatureImages.Add(14,new  FEATURE_IMAGE(14,"Дорожная разметка", 4,new int[]{464,465,466,467,468,469,470,471,472,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,488,489,490,491,492,493,494,495,496,497,498,499},null,null) );
...
allFeatureImages.Add(16,new  FEATURE_IMAGE(16,"Эксплуатационное состояние ПЧ", 0,new int[]{500,501,502,503,504,505},null,null) );
...
allFeatureImages.Add(21,new  FEATURE_IMAGE(21,"Тип освещения", 0,new int[]{509,510,511,512,513},null,null) );
...
allFeatureImages.Add(26,new  FEATURE_IMAGE(26,"Принадлежность ПЧ", 0,new int[]{506,507,508},null,null) );
...
allFeatureImages.Add(42,new  FEATURE_IMAGE(42,"Ширина 2 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>0) return true;
return false;",null) );
allFeatureImages.Add(43,new  FEATURE_IMAGE(43,"Ширина 3 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>1) return true;
return false;",null) );
allFeatureImages.Add(44,new  FEATURE_IMAGE(44,"Ширина 4 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>2) return true;
return false;",null) );
allFeatureImages.Add(45,new  FEATURE_IMAGE(45,"Ширина 5 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>3) return true;
return false;",null) );
allFeatureImages.Add(46,new  FEATURE_IMAGE(46,"Ширина 6 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>4) return true;
return false;",null) );
allFeatureImages.Add(47,new  FEATURE_IMAGE(47,"Ширина 7 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>5) return true;
return false;",null) );
allFeatureImages.Add(48,new  FEATURE_IMAGE(48,"Ширина 8 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>6) return true;
return false;",null) );
allFeatureImages.Add(49,new  FEATURE_IMAGE(49,"Ширина 9 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>7) return true;
return false;",null) );
allFeatureImages.Add(50,new  FEATURE_IMAGE(50,"Ширина 10 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>8) return true;
return false;",null) );
allFeatureImages.Add(51,new  FEATURE_IMAGE(51,"Ширина 11 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>9) return true;
return false;",null) );
allFeatureImages.Add(52,new  FEATURE_IMAGE(52,"Ширина 12 полосы (встр. напр.)", 0,new int[]{}, @"if (DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer!=null &&
DataProject.getEssencesByImage(5)[0].getFeatureByImage(28)[0].answer.intAnswer>10) return true;
return false;",null) );
...
allFeatureImages.Add(5,new  FEATURE_IMAGE(5,"место в машине", 0,new int[]{},null,null) );
        ...
        public static Essence createByImage(ESSENSES_IMEG image)
        {
            ...
            switch ( image.dbId)
            {case 8: obj8(es,features);
 break;
case 4: obj4(es,features);
 break;
case 5: obj5(es,features);
 break;
case 6: obj6(es,features);
 break;
case 18: obj18(es,features);
 break;
case 7: obj7(es,features);
 break;
case 11: obj11(es,features);
 break;
case 22: obj22(es,features);
 break;
case 12: obj12(es,features);
 break;
case 13: obj13(es,features);
 break;
case 14: obj14(es,features);
 break;
case 15: obj15(es,features);
 break;
case 19: obj19(es,features);
 break;
case 20: obj20(es,features);
 break;
case 21: obj21(es,features);
 break;
case 16: obj16(es,features);
 break;
case 17: obj17(es,features);
 break;
} 
 ...
 private static void obj18(Essence es,List<Feature> features){
  ...
  features.Add(allFeatureImages[144].getFeature(es));
  ...
  features.Add(allFeatureImages[143].getFeature(es));
 ...
 private static void obj15(Essence es,List<Feature> features){
  features.Add(allFeatureImages[145].getFeature(es));
