...
namespace TextRuler.TextRulerControl
{
    internal partial class TextRuler : UserControl
    {
        ...
        private void DrawIndents(Graphics g)
        {
            ...
            g.DrawImage( WFormsAppWordExport.Properties.Resources.l_indet_pos_upper, items[2]);
              g.DrawImage(WFormsAppWordExport.Properties.Resources.l_indent_pos_lower, items[3]);
            g.DrawImage(WFormsAppWordExport.Properties.Resources.r_indent_pos, items[4]);
        }
        ...
        private void DrawTabs(Graphics g)
        {
            ...
            {
                g.DrawImage(WFormsAppWordExport.Properties.Resources.tab_pos, tabs[i]);
            }            
        }
        #endregion
